...
<head>
    ...
    <!-- bootstrap-icons agar tombol edit & hapus jadi titik tiga -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
    <!-- endbootstrap-icons -->
    <!-- bootstrap5 summernote -->
...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © By Faqih. All rights reserved.</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Version 1.0.0</span> {{-- 1 = apk ada perubahan besar, 0 = penambahan fitur, 0 = perbaikan bug --}}
        </div>
        </footer>
        <!-- partial -->
        </div>
    ...
    <!-- installation summernote bootstrap5 -->
    <script>
    ...
    <!-- tokkenfield -->
    @stack('child-scripts') {{-- tokkenfield ada di index.blade.php karna terhubung dgn @push('child-scripts') --}}
    <!-- end tokkenfield -->
</body>
</html>
