                    ...
                    <td>
                        <div class="dropdown">        <!-- pembungkus dropdown -->   {{-- bikin titik 3 --}}
                            ...
                            <ul class="dropdown-menu">          <!-- isi menu dropdown (edit, hapus) -->
                                <li>
                                    <a href="{{ route('experience.edit', $item->id) }}" class="dropdown-item">
                                        <i class="bi bi-pencil-square me-2"></i>Edit
                                    </a>
                                </li>
                                <li>
                                <form onsubmit="return confirm('Are you sure you want to delete {{ $item->judul }} ?')" action="{{ route('experience.destroy', $item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
